...
if __name__ == "__main__":
    ...
    def model(data):
        # define the parameters that control the R0_eps prior.
        mu0 = torch.tensor(0.0) # mean of prior
        var0 = torch.tensor(1e-5) # variance of prior

        # define the prior for R0_eps
        R0_eps = pyro.sample("R0_eps", dist.Normal(mu0, var0))